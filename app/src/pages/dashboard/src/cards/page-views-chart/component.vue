...
const loadAnalytics = async () => {
  ...
  try {
    ...
    if (apiError) providerError.value = apiError;
...
const chartData = computed(() => {
  ...
  if (!rawChartData || !Array.isArray(rawChartData.labels)) return null;
...
<template>
  <div
    class="bg-white dark:bg-[#24303f] rounded-3xl p-6 h-full flex flex-col border border-zinc-200/40 dark:border-[#2e3a47] pb-3"
  >
    <!-- Loading State -->
