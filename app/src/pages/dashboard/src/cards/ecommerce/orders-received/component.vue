...
<template>
  <div class="bg-zinc-50 dark:bg-zinc-800/20 border border-zinc-200/40 dark:border-zinc-800/60 rounded-3xl p-6 h-full">
    <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">{{ __('Pedidos recebidos', 'flexify-dashboard') }}</h3>
    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">{{ __('Quantidade de pedidos no período', 'flexify-dashboard') }}</p>
    <div
      v-if="loading"
