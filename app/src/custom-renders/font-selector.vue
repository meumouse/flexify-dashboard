  ...
  <div class="col-span-2 flex flex-col gap-6">
        ...
        <button
          ...
          :class="
            fontSource === option.value
              ? 'bg-indigo-50 dark:bg-indigo-950/50 border-indigo-400 dark:border-indigo-600 text-indigo-700 dark:text-indigo-300 shadow-sm'
      ...
      <div class="flex flex-col gap-2">
        ...
        <div ref="dropdownRef" class="relative max-w-[400px]">
          ...
          <div v-else class="relative">
            <input
              ...
              class="w-full px-4 py-2.5 pl-10 bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl text-sm transition-all outline-none focus:border-indigo-400 dark:focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-900/30"
                ...
                >
                  ...
                  >
                    ...
                    <span
                      ...
                      class="flex-shrink-0 w-5 h-5 rounded-full bg-indigo-500 flex items-center justify-center"
                    >
        ...
        >
          ...
          <input
            ...
            class="px-2 py-1 bg-transparent border-b border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 text-xs focus:border-indigo-400 dark:focus:border-indigo-600 outline-none transition-colors w-40"
          />
        </div>
      </div>
          ...
          <button
            ...
            :class="
              selectedGoogleWeights.includes(weight.value)
                ? 'bg-indigo-50 dark:bg-indigo-950/50 border-indigo-400 dark:border-indigo-600 text-indigo-700 dark:text-indigo-300'
    ...
    <div v-if="fontSource === 'url'" class="flex flex-col gap-5">
      <div class="flex flex-col gap-2">
        ...
        <div class="relative max-w-[500px]">
          <input
            ...
            "
            class="w-full px-4 py-2.5 pl-10 bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl text-sm transition-all outline-none focus:border-indigo-400 dark:focus:border-indigo-600"
          />
          <AppIcon
            icon="link"
            class="absolute left-3.5 top-1/2 -translate-y-1/2 text-lg text-zinc-400"
      ...
      <div class="flex flex-col gap-2">
        ...
        <input
          ...
          class="max-w-[300px] px-4 py-2.5 bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl text-sm transition-all outline-none focus:border-indigo-400 dark:focus:border-indigo-600"
        />
        <p class="text-xs text-zinc-400 dark:text-zinc-500">
          {{
            __(
    ...
    <div v-if="fontSource === 'upload'" class="flex flex-col gap-5">
      ...
      <div class="flex flex-col gap-3">
        ...
        >
          <div
            class="w-14 h-14 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/30 transition-colors"
          >
            ...
            <template v-else>
              <AppIcon
                icon="upload"
                class="text-2xl text-zinc-400 group-hover:text-indigo-500 transition-colors"
              />
            </template>
          </div>
          <div>
            <p
              class="text-sm font-medium text-zinc-600 dark:text-zinc-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors"
            >
              {{
                isUploading
        ...
        >
          ...
          <select
            ...
            class="px-3 py-1.5 text-sm bg-zinc-50 dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 rounded-lg focus:outline-none focus:border-indigo-400"
          >
            <option
              v-for="weight in fontWeights"
              :key="weight.value"
