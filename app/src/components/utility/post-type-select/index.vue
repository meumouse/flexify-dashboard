...
<template>
  <div
    ...
    v-bind="attrs"
    ref="parent"
    class="px-2 py-2 border border-zinc-200 dark:border-zinc-700 rounded-lg w-full transition-all outline outline-transparent outline-offset-[-2px] focus:outline-brand-300 dark:focus:outline-brand-700 focus:shadow-xs text-sm col-span-2 flex flex-row gap-1 items-center"
  >
    ...
    <svg v-if="loading" class="animate-spin text-brand-500 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
