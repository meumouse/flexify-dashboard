...
class ActivityLogger
{
    ...
    public function __construct()
    {
        ...
        if (!wp_next_scheduled('flexify_dashboard_activity_log_flush')) {
            wp_schedule_event(time(), 'flexify_dashboard_30_seconds', 'flexify_dashboard_activity_log_flush');
        }
        add_action('flexify_dashboard_activity_log_flush', [self::class, 'flush_log_queue']);
    }
    ...
    {
        $schedules['flexify_dashboard_30_seconds'] = [
            'interval' => 30,
