...
class CustomPostTypesPage
{
  ...
  public function setup_admin_page()
  {
    ...
    $cf_menu_name = __("Fields groups", "flexify-dashboard");
    add_submenu_page(
      "flexify-dashboard-settings",
      $cf_menu_name,
      $cf_menu_name,
  ...
  public static function load_styles()
  {
    ...
    wp_enqueue_style("flexify-dashboard-custom-post-types", $style, [], FLEXIFY_DASHBOARD_VERSION);
  }
  ...
  public function render_page()
  {
    ...
    ?>
    <div id="fd-custom-post-types-page"></div>
    <?php
  }
}
