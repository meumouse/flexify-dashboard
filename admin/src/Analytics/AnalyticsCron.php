...
class AnalyticsCron
{
    ...
    public function __construct()
    {
        ...
        add_action('flexify_dashboard_analytics_aggregate', [$this, 'aggregate_analytics_data']);
        add_action('flexify_dashboard_analytics_cleanup', [$this, 'cleanup_old_data']);
    ...
    public function schedule_cron_jobs()
    {
        ...
        if (!wp_next_scheduled('flexify_dashboard_analytics_aggregate')) {
            wp_schedule_event(time(), 'every_30_minutes', 'flexify_dashboard_analytics_aggregate');
        }

        // Schedule cleanup daily at 2 AM
        if (!wp_next_scheduled('flexify_dashboard_analytics_cleanup')) {
            wp_schedule_event(time(), 'daily', 'flexify_dashboard_analytics_cleanup');
        }
    }
    ...
    private function process_daily_aggregation($last_aggregation)
    {
        ...
        $pageviews_table = $wpdb->prefix . 'flexify_dashboard_analytics_pageviews';
        $daily_table = $wpdb->prefix . 'flexify_dashboard_analytics_daily';
    ...
    private function process_referrers_aggregation($last_aggregation)
    {
        ...
        $pageviews_table = $wpdb->prefix . 'flexify_dashboard_analytics_pageviews';
        $referrers_table = $wpdb->prefix . 'flexify_dashboard_analytics_referrers';
    ...
    private function process_devices_aggregation($last_aggregation)
    {
        ...
        $pageviews_table = $wpdb->prefix . 'flexify_dashboard_analytics_pageviews';
        $devices_table = $wpdb->prefix . 'flexify_dashboard_analytics_devices';
    ...
    private function process_geo_aggregation($last_aggregation)
    {
        ...
        $pageviews_table = $wpdb->prefix . 'flexify_dashboard_analytics_pageviews';
        $geo_table = $wpdb->prefix . 'flexify_dashboard_analytics_geo';
    ...
    private function update_summary_cache()
    {
        ...
        $summary_table = $wpdb->prefix . 'flexify_dashboard_analytics_summary';
        $daily_table = $wpdb->prefix . 'flexify_dashboard_analytics_daily';
    ...
    private function get_last_aggregation_time()
    {
        ...
        $settings_table = $wpdb->prefix . 'flexify_dashboard_analytics_settings';
    ...
    {
        wp_clear_scheduled_hook('flexify_dashboard_analytics_aggregate');
        wp_clear_scheduled_hook('flexify_dashboard_analytics_cleanup');
    }
}
