 ...
 * All analytics providers (flexifyDashboard built-in, Google Analytics, etc.) must implement this interface.
 * 
...
interface AnalyticsProviderInterface
{
     ...
     * 
     * @return string Provider identifier (e.g., 'flexify-dashboard', 'google_analytics')
     */
