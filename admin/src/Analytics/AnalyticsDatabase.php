...
class AnalyticsDatabase
{
    ...
    public function maybe_initialize_analytics_tables()
    {
        ...
        if (!isset($settings['enable_flexify_dashboard_analytics']) || !$settings['enable_flexify_dashboard_analytics']) {
            return;
        }
    ...
    private function tables_exist()
    {
        ...
        $tables = [
            'wp_flexify_dashboard_analytics_pageviews',
            'wp_flexify_dashboard_analytics_daily',
            'wp_flexify_dashboard_analytics_referrers',
            'wp_flexify_dashboard_analytics_devices',
            'wp_flexify_dashboard_analytics_geo',
            'wp_flexify_dashboard_analytics_summary',
            'wp_flexify_dashboard_analytics_settings'
        ];
    ...
    private function create_analytics_tables()
    {
        ...
        $sql_pageviews = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_pageviews (
        ...
        $sql_daily = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_daily (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            date DATE NOT NULL,
            page_url VARCHAR(500) NOT NULL,
            page_title VARCHAR(255) DEFAULT NULL,
        ...
        $sql_referrers = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_referrers (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            date DATE NOT NULL,
        ...
        $sql_devices = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_devices (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            date DATE NOT NULL,
        ...
        $sql_geo = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_geo (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            date DATE NOT NULL,
        ...
        $sql_summary = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_summary (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        ...
        $sql_settings = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}flexify_dashboard_analytics_settings (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    {
        $settings = get_option('flexify_dashboard_settings', []);
        return isset($settings['enable_flexify_dashboard_analytics']) && $settings['enable_flexify_dashboard_analytics'];
    }
