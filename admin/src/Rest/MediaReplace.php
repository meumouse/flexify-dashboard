...
class MediaReplace
{
  ...
  {
    add_action("rest_api_init", ["MeuMouse\Flexify_Dashboard\Rest\MediaReplace", "register_custom_endpoints"]);
  }
  ...
  public static function register_custom_endpoints()
  {
    ...
    register_rest_route('flexify-dashboard/v1', '/media/replace', [
      'methods' => 'POST',
      'callback' => ['MeuMouse\Flexify_Dashboard\Rest\MediaReplace', 'replace_media_file'],
      'permission_callback' => ['MeuMouse\Flexify_Dashboard\Rest\MediaReplace', 'check_permissions'],
