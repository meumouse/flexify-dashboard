...
class Analytics
{
    ...
    public function register_analytics_routes()
    {
        ...
        register_rest_route('flexify-dashboard/v1', '/analytics/active-users', [
            'methods' => 'GET',
        ...
        register_rest_route('flexify-dashboard/v1', '/analytics/stats', [
            'methods' => 'GET',
        ...
        register_rest_route('flexify-dashboard/v1', '/analytics/track', [
            'methods' => 'POST',
        ...
        register_rest_route('flexify-dashboard/v1', '/analytics/settings', [
            'methods' => 'GET',
        ...
        register_rest_route('flexify-dashboard/v1', '/analytics/chart', [
            'methods' => 'GET',
     ...
     * (flexifyDashboard built-in or Google Analytics).
     * 
     * @param \WP_REST_Request $request The REST request object
    ...
    private function get_overview_stats($start_date, $end_date, $page_url = null)
    {
        ...
        $table_name = $wpdb->prefix . 'flexify_dashboard_analytics_daily';
    ...
    private function get_referrers_stats($start_date, $end_date)
    {
        ...
        $table_name = $wpdb->prefix . 'flexify_dashboard_analytics_referrers';
    ...
    private function get_devices_stats($start_date, $end_date)
    {
        ...
        $table_name = $wpdb->prefix . 'flexify_dashboard_analytics_devices';
    ...
    private function get_geo_stats($start_date, $end_date)
    {
        ...
        $table_name = $wpdb->prefix . 'flexify_dashboard_analytics_geo';
    ...
    private function get_or_create_session_id()
    {
        ...
        $cookie_name = 'flexify_dashboard_analytics_session';
