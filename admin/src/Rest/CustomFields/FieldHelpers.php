 ...
 */
define('UIXPRESS_FIELD_CACHE_KEY', 'flexify_dashboard_field_definitions');
 ...
 */
function flexify_dashboard_get_field($field_name, $object_id = null, $options = []) {
    // Validate field name
    ...
    $context = $options['context'] ?: _flexify_dashboard_detect_context($object_id);
 ...
 * @param string   $field_name The field name (meta key)
 * @param int|null $object_id  Optional. The object ID. Auto-detected if null.
 * @param array    $options    Optional. Array of options (see flexify_dashboard_get_field)
 *
 * @return void
 */
function flexify_dashboard_the_field($field_name, $object_id = null, $options = []) {
    ...
    if (is_array($value) || is_object($value)) {
        ...
        if ($options['format'] === 'html') {
            echo _flexify_dashboard_render_html($value, $field_type, $options);
        } else {
 ...
 */
function flexify_dashboard_get_post_field($field_name, $post_id = null, $options = []) {
 ...
 * @return mixed The field value
 */
function flexify_dashboard_get_term_field($field_name, $term_id, $options = []) {
    if (!$term_id) {
 ...
 * @return mixed The field value
 */
function flexify_dashboard_get_user_field($field_name, $user_id = null, $options = []) {
    if ($user_id === null) {
 ...
 * @return mixed The field value
 */
function flexify_dashboard_get_comment_field($field_name, $comment_id, $options = []) {
    if (!$comment_id) {
        return $options['default'] ?? null;
    }
 ...
 */
function flexify_dashboard_get_image_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'size' => 'full',
        'context' => null,
        'default' => null,
    ...
    $value = flexify_dashboard_get_field($field_name, $object_id, [
        'format' => 'raw',
 ...
 */
function flexify_dashboard_get_file_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'context' => null,
        'default' => null,
    ]);
 ...
 */
function flexify_dashboard_get_link_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'format' => 'array',
        'class' => '',
        'context' => null,
 ...
 */
function flexify_dashboard_get_repeater_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'context' => null,
    ]);
 ...
 */
function flexify_dashboard_get_relationship_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'return' => 'objects',
        'context' => null,
    ]);
 ...
 */
function flexify_dashboard_get_google_map_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'context' => null,
        'default' => null,
    ]);
 ...
 */
function flexify_dashboard_get_date_field($field_name, $object_id = null, $options = []) {
    $options = wp_parse_args($options, [
        'format' => 'Y-m-d',
        'context' => null,
        'default' => null,
 ...
 */
function flexify_dashboard_have_field($field_name, $object_id = null, $options = []) {
    $value = flexify_dashboard_get_field($field_name, $object_id, array_merge($options, ['format' => 'raw']));
 ...
 * values are stored in the wp_options table under 'flexify_dashboard_options_{page_slug}'.
 *
 ...
 * $company_name = flexify_dashboard_get_option_field('company_name', 'general-settings');
 *
 * // Get with default value
 * $phone = flexify_dashboard_get_option_field('phone', 'contact', ['default' => 'N/A']);
 *
 * // Get raw value
 * $data = flexify_dashboard_get_option_field('complex_field', 'settings', ['format' => 'raw']);
 */
function flexify_dashboard_get_option_field($field_name, $page_slug, $options = []) {
    // Validate inputs
    if (empty($field_name) || !is_string($field_name)) {
        return null;
    }
 ...
 * @param string $field_name The field name
 * @param string $page_slug  The option page slug
 * @param array  $options    Optional. Array of options (see flexify_dashboard_get_option_field)
 *
 * @return void
 */
function flexify_dashboard_the_option_field($field_name, $page_slug, $options = []) {
    $options['format'] = $options['format'] ?? 'escaped';
 ...
 */
function flexify_dashboard_get_option_page_values($page_slug, $options = []) {
    if (empty($page_slug) || !is_string($page_slug)) {
        return [];
    }
...
function flexify_dashboard_have_option_field($field_name, $page_slug) {
    $value = flexify_dashboard_get_option_field($field_name, $page_slug, ['format' => 'raw']);
 ...
 */
function flexify_dashboard_get_option_image_field($field_name, $page_slug, $options = []) {
    $options = wp_parse_args($options, [
        'size' => 'full',
        'default' => null,
    ]);
 ...
 */
function _flexify_dashboard_render_html($value, $field_type, $options = []) {
    switch ($field_type) {
        case 'link':
            return _flexify_dashboard_render_link_html($value, $options['class'] ?? '');
